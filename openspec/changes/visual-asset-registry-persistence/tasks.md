...
- [ ] 2.1 Add an owned test-only table creation helper gated behind explicit test/runtime options.
...
- [ ] 3.1 Add read-side summary helper that returns lifecycle counts, `status_display_profiles`, review counts, renderer target counts, and safety flags.
- [ ] 3.2 Add tests proving read payloads do not import displaytools / visual-compressor / vis_2_dis and do not read payload files.
