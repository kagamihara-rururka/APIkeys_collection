# bounded-scheduler-core-contract Specification

## Purpose

This capability defines how RRKAL Core may describe bounded scheduler planning evidence without implementing a runtime scheduler, durable queue migration, lifecycle event automation, or downstream renderer/compressor integration.
