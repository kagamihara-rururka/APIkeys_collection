...
| Core readiness review item identity aggregation | `feb183a` / `core_review_item_identity_contract_draft.v1` exposed through `--core-readiness-report-json` review evidence |
| Core readiness review item identity aggregation CI | GitHub Actions run `26849126467` PASS |
...
| Core readiness scheduler evidence aggregation | `26e7d63` / scheduler contracts exposed inside `--core-readiness-report-json` `job_status_evidence` |
| Core readiness scheduler evidence aggregation CI | GitHub Actions run `26847859365` PASS |
...
- `existing_evidence.scheduler_queue_ddl_preview.schema_version = core_scheduler_queue_persistence_contract.v1`
- `existing_evidence.scheduler_queue_ddl_preview.persistence_status = not_materialized`
- `existing_evidence.scheduler_queue_ddl_preview.creates_database_state = false`
