...
- missing evidence 包含 scheduler contract 尚未接 runtime / persistence、durable queue persistence 尚未 materialize、cross-process SQLite coordination、cancellation/retry/timeout policy、job event status stream。
